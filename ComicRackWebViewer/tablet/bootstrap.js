...
Ext.Loader.addClassPathMappings({
  "Comic": "app",
  "Comic.Scrollerfix": "app/scrollerfix.js",
  "Comic.controller.Comic": "app/controller/Comic.js",
  "Comic.store.Comic": "app/store/Comic.js",
  "Comic.view.Comic": "app/view/Comic.js",
  "Ext": "touch/src",
  ...
  "Ext.data.proxy.OData": "lib/ux/OData.js",
  ...
  "Ext.ux.BufferedList": "lib/ux/BufferedList.js",
  "Ext.ux.Cover": "lib/ux/Cover.js",
  "Ext.ux.IOS5Toggle": "lib/ux/IOS5Toggle.js",
...
Ext.ClassManager.addNameAlternateMappings({
  ...
  "Comic.controller.ComicList": [],
  "Comic.controller.ComicListSettings": [],
  "Comic.controller.ComicSettings": [],
  "Comic.controller.Login": [],
  "Comic.controller.Main": [],
  "Comic.controller.Search": [],
  "Comic.controller.Series": [],
  "Comic.controller.TreeList": [],
  ...
  "Ext.ux.data.Connection": [],
  "Ext.ux.data.proxy.OData": [
    "Ext.ux.data.ProxyOData"
  ],
  "Ext.ux.data.reader.OData": [
    "Ext.ux.data.ReaderOData"
  ],
...
Ext.ClassManager.addNameAliasMappings({
  ...
  "Comic.view.ComicGrid": [
    "widget.comicgridview"
  ],
  "Comic.view.ComicInfo": [
    "widget.comicinfoview"
  ],
  "Comic.view.ComicList": [
    "widget.comiclistview"
  ],
  "Comic.view.ComicListSettings": [
    "widget.comiclistsettingsview"
  ],
  "Comic.view.ComicListSort": [
    "widget.comiclistsortview"
  ],
  "Comic.view.ComicSettings": [
    "widget.comicsettingsview"
  ],
  "Comic.view.ImageViewer": [
    "widget.imageviewer"
  ],
  ...
  "Ext.ux.IOS5Toggle": [
    "widget.ios5togglefield"
  ],
  "Ext.ux.IconSpinner": [
    "widget.iconspinnerfield"
  ],
  "Ext.ux.MenuButton": [],
  "Ext.ux.TabMenuButton": [],
  "Ext.ux.data.Connection": [],
